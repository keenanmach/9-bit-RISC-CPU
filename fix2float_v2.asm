...
loop:
	...
	ldi 0
	and r7, r1	;r7 = 0
	ldr r0, if3 ;ASSUMED r0 IS GARBAGE VALUE
	bne	r6, r7
	lsl r0, 1
	ldi 0
	and r6, r1	;r6 = 0
	...
	lsl r1, 2
	add r7, r1
	ldr r0, if2 ;ASSUMED r0 IS GARGABE VALUE
	bne r6, r7
	ldi 1
	add r0, r1
if2:
...
if3:	
	...
	add r6, r0	;r6 = MSW
	and r6, r5	;r6 = mask & MSW
	ldr r0, loop	;ASSUMED r0 IS GARBAGE VALUE loop again if mask & MSW != 0
	...
	ldi 0
	and r7, r1
	ldr r0, if5 ;ASSUMED r0 IS GARBAGE VALUE
	bne r6, r7
	ldi 0
	and r6, r1
	ldi 0b11111
	...
	ldr r0, if4 ;ASSUMED r0 IS GARBAGE VALUE
	bne r6, r7
	ldi 1
	add r0, r1
if4:
...
if5:
	...
	ldi 0
	and r7, r1
	ldr r0, if7 ;ASSUMED r0 IS GARBAGE VALUE
	bne r6, r7
	ldi 0
	and r6, r1
	ldi 0b11111
	...
	add r7, r1
	lsl r7, 3	;r7 = 0b11111000
	ldr r0, if6 ;ASSUMED r0 IS GARBAGE VALUE
	bne r6, r7
	ldi 1
	add r0, r1
if6:
...
if7:
	...
	ldi 0
	and r7, r1
	ldr r0, done ;ASSUMED r0 IS GARBAGE VALUE
	bne r6, r7
	lsr r0, 1
	lsr r2, 1
done:
